...
Cells are `TPR / PPV` at p < 0.05.
`fail` = method errored out;   `see v2_median` = same MSstats internal normalization as v2_median.

### post-swap

| Method | V1_log2 | v2_median | v2_vsn | v3_quantile |
|---|---|---|---|---|
| MSstats+ | 0.387 / 0.796 | 0.703 / 0.797 | see v2_median | fail |
| MSstats | 0.231 / 0.721 | 0.580 / 0.788 | see v2_median | fail |
...
| Method | V1_log2 | v2_median | v2_vsn | v3_quantile |
|---|---|---|---|---|
| MSstats+ | 0.009 / 0.083 | 0.019 / 0.098 | see v2_median | fail |
| MSstats | 0.005 / 0.050 | 0.019 / 0.108 | see v2_median | fail |
